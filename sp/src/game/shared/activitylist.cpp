...
//HL2MP
	...
	REGISTER_SHARED_ACTIVITY(ACT_VM_MELEEHIT);
	REGISTER_SHARED_ACTIVITY(ACT_VM_MELEEHIT2);
	REGISTER_SHARED_ACTIVITY(ACT_VM_MELEEHIT3);
	REGISTER_SHARED_ACTIVITY(ACT_VM_MELEEHIT_EMPTY);
	REGISTER_SHARED_ACTIVITY(ACT_VM_MELEEHIT_EMPTY2);
	REGISTER_SHARED_ACTIVITY(ACT_VM_MELEEHIT_EMPTY3);

	REGISTER_SHARED_ACTIVITY(ACT_VM_MELEEMISS);
	REGISTER_SHARED_ACTIVITY(ACT_VM_MELEEMISS2);
	REGISTER_SHARED_ACTIVITY(ACT_VM_MELEEMISS3);
	REGISTER_SHARED_ACTIVITY(ACT_VM_MELEEMISS_EMPTY);
	REGISTER_SHARED_ACTIVITY(ACT_VM_MELEEMISS_EMPTY2);
	REGISTER_SHARED_ACTIVITY(ACT_VM_MELEEMISS_EMPTY3);
