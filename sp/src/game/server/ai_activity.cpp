...
//===========================
	...
	ADD_ACTIVITY_TO_SR(ACT_VM_MELEEHIT);
	ADD_ACTIVITY_TO_SR(ACT_VM_MELEEHIT2);
	ADD_ACTIVITY_TO_SR(ACT_VM_MELEEHIT3);
	ADD_ACTIVITY_TO_SR(ACT_VM_MELEEHIT_EMPTY);
	ADD_ACTIVITY_TO_SR(ACT_VM_MELEEHIT_EMPTY2);
	ADD_ACTIVITY_TO_SR(ACT_VM_MELEEHIT_EMPTY3);

	ADD_ACTIVITY_TO_SR(ACT_VM_MELEEMISS);
	ADD_ACTIVITY_TO_SR(ACT_VM_MELEEMISS2);
	ADD_ACTIVITY_TO_SR(ACT_VM_MELEEMISS3);
	ADD_ACTIVITY_TO_SR(ACT_VM_MELEEMISS_EMPTY);
	ADD_ACTIVITY_TO_SR(ACT_VM_MELEEMISS_EMPTY2);
	ADD_ACTIVITY_TO_SR(ACT_VM_MELEEMISS_EMPTY3);
